<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageKhmer.master" AutoEventWireup="false" CodeFile="serviceskh.aspx.vb" Inherits="services" %>
...
<h2 class="mb-4">សេវាកម្មរបស់យើងខ្ញុំ</h2>
</div>
</div>
<div class="row">
...
<h3 class="mb-2">ការពិនិត្យភ្នែកទារក</h3>
...
<div class="staff" >
<div class="text text-center" style="height: 200px;">
<h3 class="mb-2">ការពិនិត្យភ្នែកប្រចាំឆ្នាំ និងការពិនិត្យភ្នែកមុនចូលសាលា </h3>
<span class="position mb-2"></span>
...
<div class="staff" >
<div class="text text-center" style="height: 200px;">
<h3 class="mb-2">ការពិគ្រោះយោបល់ភ្នែក</h3>
<span class="position mb-2"></span>
...
<div class="staff" >
<div class="text text-center" style="height: 200px;">
<h3 class="mb-2">ការព្យាបាលភ្នែក និងវះកាត់</h3>
<span class="position mb-2"></span>
...
<div class="staff" >
<div class="text text-center" style="height: 200px;">
<h3 class="mb-2">ការបាញ់កាំរស្មីនិងវ៉ែនតា</h3>
<span class="position mb-2"></span>
